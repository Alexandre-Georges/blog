...
const socialMedias = [
  {
    link: 'https://github.com/alexandre-georges',
    viewBox: '0 0 26 28',
    title: 'GitHub',
    path:
  ...
  {
    link: 'https://www.linkedin.com/in/algeorges/',
    viewBox: '0 0 24 24',
    title: 'LinkedIn',
    path:
...
const Aside = ({ location }) => (
  <aside className="biography">
    <StaticImage
      ...
      className="photo"
    />
    <span className="name">Alexandre Georges</span>
    <p className="tagline">Software engineer and all around crafter.</p>
    <ul className="simple-list menu-links">
      {links.map(link => (
        <li key={link.path} className="menu-link-item">
          <Link to={link.path} className={getLinkClasses(link.path, location)}>
            {link.label}
          </Link>
        </li>
      ))}
    </ul>
    <ul className="simple-list social-media-links">
      {socialMedias.map(socialMedia => (
        <li key={socialMedia.title} className="social-media-item">
          <a
          ...
          >
            <svg viewBox={socialMedia.viewBox} className="social-media-icon">
              <title>GitHub</title>
